...
int main()
{
  ...
  // copy construction of non AA type
  {
    ...
    std::basic_optional<tracker1, DummyAlloc2<tracker1>> o2 = std::move(o1);;
    VERIFY( o2.get_allocator().id == 5 );
    VERIFY( o2 );
  ...
  // allocator extended copy construction of non AA type
  {
    ...
    std::basic_optional<tracker1, DummyAlloc2<tracker1>> o2{std::allocator_arg, testAlloc2, std::move(o1)};
    VERIFY( o2.get_allocator().id == 15 );
    VERIFY( o2 );
    VERIFY( o2.value().alloc.id == 0 );
  }
