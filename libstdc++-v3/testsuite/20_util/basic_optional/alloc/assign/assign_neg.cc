...
{
  {
    ...
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o2;

    o1 = o2; // { dg-error "no match" }
  }
  {
    std::basic_optional<tracker1, DummyAlloc2<tracker1>> o1;
    std::basic_optional<int, DummyAlloc2<int>> o2;
    o1 = o2; // { dg-error "no match" }
  }
  {
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1;
    std::basic_optional<bob, DummyAlloc1<tracker1>> o2;
    o1 = o2; // { dg-error "no match" }
  }
  {
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1;
    std::basic_optional<bob, DummyAlloc1<bob>> o2;
    o1 = o2; // { dg-error "no match" }
  }
  {
    std::basic_optional<tracker1, DummyAlloc2<tracker1>> o1;
    std::basic_optional<bob, DummyAlloc2<bob>> o2;
    o1 = o2; // { dg-error "no match" }
  }
