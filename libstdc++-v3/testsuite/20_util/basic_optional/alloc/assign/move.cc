...
int main()
{

  {
    ...
    DummyAlloc1<tracker1> testAlloc2{3};
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o2{std::allocator_arg, testAlloc2};
    VERIFY( o2.get_allocator().id == 3 );
    VERIFY( !o2 );

    o1 = std::move(o2);;
    VERIFY( o1.get_allocator().id == 3 );


    DummyAlloc1<tracker1> testAlloc3{6};
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o3{std::allocator_arg, testAlloc3, std::in_place};
    VERIFY( o3.get_allocator().id == 6 );
    VERIFY( o3 );

    o1 = std::move(o3);
    VERIFY( o1.get_allocator().id == 6 );
    VERIFY( o1 );
  ...
  }
  {
    ...
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1{std::allocator_arg, testAlloc1};
    VERIFY( o1.get_allocator().id == 5 );
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o2{std::allocator_arg, testAlloc1};
    VERIFY( o2.get_allocator().id == 5 );
    VERIFY( !o1 );
    VERIFY( !o2 );
    o1 = std::move(o2);;
    VERIFY( o1.get_allocator().id == 5 );
...

  {
    ...
    DummyAlloc2<tracker2> testAlloc2{3};
    std::basic_optional<tracker2, DummyAlloc2<tracker2>> o2{std::allocator_arg, testAlloc2};
    VERIFY( o2.get_allocator().id == 3 );
    VERIFY( !o2 );
  ...
  }
  {
    ...
    std::basic_optional<tracker2, DummyAlloc2<tracker2>> o1{std::allocator_arg, testAlloc1};
    VERIFY( o1.get_allocator().id == 5 );
    std::basic_optional<tracker2, DummyAlloc2<tracker2>> o2{std::allocator_arg, testAlloc1};
    VERIFY( o2.get_allocator().id == 5 );
    VERIFY( !o1 );
    VERIFY( !o2 );
    o1 = std::move(o2);;
