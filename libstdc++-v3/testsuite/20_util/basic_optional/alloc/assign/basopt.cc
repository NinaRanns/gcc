...
int main()
{
// copy assign from basic_optional, same type, convertible allocator
  {
...
// move assign from  basic_optional, same type, convertible allocator
  {
    DummyAlloc1<char> testAlloc1{5};
    std::basic_optional<tracker1, DummyAlloc1<char>> o1{std::allocator_arg, testAlloc1};
    VERIFY( o1.get_allocator().id == 5 );
...
// copy assign from basic_optional, convertible type, same allocator
  {
    DummyAlloc1<tracker1> testAlloc1{5};
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1{std::allocator_arg, testAlloc1};
    VERIFY( o1.get_allocator().id == 5 );
    DummyAlloc1<tracker1> testAlloc2{15};
    std::basic_optional<int, DummyAlloc1<tracker1>> o2{std::allocator_arg, testAlloc2};
...
// move assign from basic_optional, convertible type, same allocator
  {
    DummyAlloc1<tracker1> testAlloc1{5};
    std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1{std::allocator_arg, testAlloc1};
    VERIFY( o1.get_allocator().id == 5 );
  ...
  // copy assign from basic_optional, convertible type, convertible allocator
    {
      DummyAlloc1<tracker1> testAlloc1{5};
      std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1{std::allocator_arg, testAlloc1};
      VERIFY( o1.get_allocator().id == 5 );
      DummyAlloc1<int> testAlloc2{15};
      std::basic_optional<int, DummyAlloc1<int>> o2{std::allocator_arg, testAlloc2};
  ...
  // move assign from basic_optional, convertible type, convertible allocator
    {
      DummyAlloc1<tracker1> testAlloc1{5};
      std::basic_optional<tracker1, DummyAlloc1<tracker1>> o1{std::allocator_arg, testAlloc1};
      VERIFY( o1.get_allocator().id == 5 );
