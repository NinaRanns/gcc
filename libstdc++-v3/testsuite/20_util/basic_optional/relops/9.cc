...
{
  using ns::value_type;
  using O = std::basic_optional<value_type>;
  using P = std::basic_optional<value_type, ns::DummyAlloc1<value_type> >;
  {
    O o;
    P p;
    VERIFY( !(o < p) );
