...
int main()
{
...

  {
    ...
    std::basic_optional<long> o { std::in_place, val};
    auto copy = o;
    VERIFY( copy );
    VERIFY( *copy == val );
    VERIFY( o && o == val );
  ...
  {
    std::basic_optional<tracker> o { std::in_place, 333 };
    auto copy = o;
    VERIFY( copy );
...

  {
    ...
    std::basic_optional<throwing_copy> o;
  ...
  {
    outcome result = nothrow;
    std::basic_optional<throwing_copy> o { std::in_place };
