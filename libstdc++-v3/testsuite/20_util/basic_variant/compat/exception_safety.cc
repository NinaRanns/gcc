...
test01()
{
  ...
  std::basic_variant<std::allocator<int>,int, std::pmr::string, std::pmr::vector<int>> v(1);
  VERIFY( v.index() == 0 );
...
test02()
{
  ...
  std::basic_variant<std::allocator<int>,std::monostate, int, X> v(111);
  VERIFY( v.index() == 1 );
...
test03()
{
  ...
  std::basic_variant<std::allocator<int>,std::monostate, int, TriviallyCopyable, std::optional<int>,
...
test04()
{
  ...
  std::basic_variant<std::allocator<int>,int, ThrowOnCopy> v1(std::in_place_type<ThrowOnCopy>), v2(2);
  try
  {
    v2 = v1; // uses basic_variant<std::allocator<int>,Types...>::operator=(const variant&)
    VERIFY( false );
  }
  catch (int)
  {
  ...
  {
    ThrowOnCopy toc;
    v2 = toc; // uses basic_variant<std::allocator<int>,Types...>::operator=(T&&)
    VERIFY( false );
  }
  catch (int)
  {
