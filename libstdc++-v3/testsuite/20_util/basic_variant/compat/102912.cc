...
test01()
{
  ...
  std::basic_variant<std::allocator<int>, const int, const X> v;
  auto vv = v;
}
...
test02()
{
  ...
  using V = std::basic_variant<std::allocator<int>, int, const int, const Y, Y>;
...
test03()
{
  ...
  using V = std::basic_variant<std::allocator<int>,int, int, Y, Y>;
