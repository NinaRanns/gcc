...
test01()
{
  ...
  std::basic_variant<std::allocator<int>,int, char> v1{'c'};
  std::basic_variant<std::allocator<int>,void*, const char*> v2{"chars"};
...
void test02()
{
  ...
  std::basic_variant<std::allocator<int>,int, double> v;
