...
test_assign()
{
  std::basic_variant<std::allocator<int>,int, double> v1(1);
  v1 = 2.5;
  ...
  std::basic_variant<std::allocator<int>,int, S> v;
  v = S(123);
...
test_emplace()
{
  ...
  std::basic_variant<std::allocator<int>,int, double, S> v(1);
...
test_swap()
{
  std::basic_variant<std::allocator<int>,int, double> v1(1), v2(2.5);
  v1.swap(v2);
  VERIFY( std::get<double>(v1) == 2.5 );
  ...
  std::basic_variant<std::allocator<int>,int, S> v3(3), v4(S(4));
  v3.swap(v4);
