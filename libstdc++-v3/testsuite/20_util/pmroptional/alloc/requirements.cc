...
struct no_default_constructor
{
   ...
   no_default_constructor(no_default_constructor const&) = default;
   no_default_constructor(no_default_constructor&&) = default;
   no_default_constructor(std::allocator_arg_t,allocator_type) = delete;
   no_default_constructor(std::allocator_arg_t,allocator_type,no_default_constructor const&){};
   no_default_constructor(std::allocator_arg_t,allocator_type,no_default_constructor&&){};
   no_default_constructor& operator=(no_default_constructor const&) = default;
   no_default_constructor& operator=(no_default_constructor&&) = default;
};
...
struct no_copy_constructor
{
  ...
  no_copy_constructor(std::allocator_arg_t,allocator_type) = delete;
  no_copy_constructor(std::allocator_arg_t,allocator_type,no_copy_constructor const&) = delete;
  no_copy_constructor(std::allocator_arg_t,allocator_type,no_copy_constructor&&){};
...
struct no_copy_assignment
{
  ...
  no_copy_assignment(std::allocator_arg_t,allocator_type){};
  no_copy_assignment(std::allocator_arg_t,allocator_type,no_copy_assignment const&){};
  no_copy_assignment(std::allocator_arg_t,allocator_type,no_copy_assignment&&){};
...
struct no_move_constructor
{
  ...
  no_move_constructor(std::allocator_arg_t,allocator_type){};
  no_move_constructor(std::allocator_arg_t,allocator_type,no_move_constructor const&){};
  no_move_constructor(std::allocator_arg_t,allocator_type,no_move_constructor&&) = delete;
...
struct no_move_assignment
{
  ...
  no_move_assignment(std::allocator_arg_t,allocator_type){};
  no_move_assignment(std::allocator_arg_t,allocator_type,no_move_assignment const&){};
  no_move_assignment(std::allocator_arg_t,allocator_type,no_move_assignment&&){};
...
struct only_destructible
{
  ...
  only_destructible(std::allocator_arg_t,allocator_type,only_destructible&&) = delete;
};
...
struct JustEq {};
bool operator==(const JustEq&, const JustEq&){return true;};
