...
struct value_type_aa : private mixin_counter
{
  ...
  value_type_aa(int) : state(1) { }
  value_type_aa(std::initializer_list<char>, const char*) : state(2) { }
  int state = 0;
  ...
  value_type_aa(std::allocator_arg_t,allocator_type, std::initializer_list<char> il, const char* c)
    : value_type_aa(il,c){}
};
