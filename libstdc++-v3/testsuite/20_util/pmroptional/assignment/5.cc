...
struct value_type_aa : private mixin_counter {
  ...
  value_type_aa(value_type_aa const& other) = default;

  value_type_aa(value_type_aa &&other) = default;

  value_type_aa& operator=(value_type_aa const& other)  = default;
  value_type_aa& operator=(value_type_aa&& other)  = default;
